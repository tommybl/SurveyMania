...
(7, 7, NULL, 50, NULL),
(8, 7, NULL, 68, NULL),
(6, 7, NULL, NULL, 'Jimmy Wales ainsi que Larry Sanger ont lancé Wikipédia le 15 janvier 2001. Bien que son contenu ait alors été principalement en anglais, il est rapidement devenu multilingue, grâce en partie au lancement des versions internationales de Wikipédia. Toutes ces versions sont semblables les unes aux autres, mais il existe des différences notamment dans le contenu et les techniques d''édition. Le Wikipédia anglais n''est maintenant qu''un parmi plus de deux cents autres Wikipédia, il reste néanmoins le Wikipédia le plus complet avec plus de 4,6 millions d''articles.'),
(6, 7, NULL, NULL, 'N''importe qui pouvant accéder au site peut modifier la quasi-totalité de ses articles. Wikipédia est le sixième site le plus fréquenté, et constitue le plus grand et le plus populaire des ouvrages de références générales d''Internet. En février 2014, il y avait presque 500 millions de visiteurs chaque mois. Wikipédia dispose de 22 millions de comptes, dont plus de 73 000 sont considérés éditeurs actifs, et ce à l''échelle mondiale au mois de mai 2014.'),
(6, 7, NULL, NULL, 'Le wiki est hébergé sur Internet grâce aux serveurs financés par la Wikimedia Foundation, organisation à but non lucratif américaine et dépositaire de la marque Wikipédia.'),
(6, 7, NULL, NULL, 'Wikipédia (Wikipedia en anglais) est un projet d''encyclopédie universelle, multilingue (291 langues mi-2015), sous licence CC-BY-SA 3.0, créée par Jimmy Wales et Larry Sanger le 15 janvier 20011 en wiki sous le nom de domaine wikipedia.org.'),
(6, 7, NULL, NULL, 'Wikipédia fut d''abord créée comme un projet secondaire alimentant Nupedia, maintenant disparue, fondé par Jimmy Wales, qui en était l''actionnaire majoritaire3,4 afin de produire une encyclopédie libre. Nupedia avait des procédures de révision élaborées (elle était placée sous le contrôle d''un comité scientifique), et exigeait la participation de contributeurs hautement qualifiés. En 2000, année de lancement du projet, la rédaction d''articles était particulièrement lente, malgré l''existence d''une liste de discussion des éditeurs intéressés, et un rédacteur en chef à plein temps, Larry Sanger. Au cours de la première année de Nupedia, Wales et Sanger ont discuté de divers moyens pour compléter Nupedia avec un projet plus ouvert et complémentaire. Wales raconte que Jeremy Rosenfled, un salarié de Bomis, lui avait présenté le concept du wiki. Indépendamment, Ben Kovitz, un développeur, habitué du wiki de Ward Cunningham (WikiWikiWeb) a présenté l''idée d''un wiki à Sanger, au cours d''un dîner le 2 janvier 2001. Sanger pensait qu''un wiki serait une bonne plate-forme, et a proposé sur la liste de diffusion de Nupedia, dans un message intitulé « Let''s make a wiki » (Faisons un wiki), qu''un UseModWiki (version 0.9.0) serait installé, afin d''alimenter Nupedia : « Non, ce n''est pas une proposition indécente. C''est une idée pour ajouter une petite capacité supplémentaire à Nupedia. Jimmy Wales pense que de nombreuses personnes pourraient trouver l''idée sujette à caution, mais je ne le pense pas. (…) L''utilisation d''un wiki par Nupedia est le format ULTIME, « ouvert » et simple pour développer du contenu. Nous nous sommes occasionnellement regroupés autour d''idées pour des projets plus simples, plus ouverts, pour soit remplacer soit suppléer Nupedia. Il me semble que les wikis peuvent être déployés pratiquement instantanément, n''ont besoin que de très peu de maintenance, et en général sont très peu risqués. Ils sont aussi une source de contenu potentiellement importante. Donc il n''y a que de petits inconvénients, aussi loin que je peux en voir5. » Wales installa ce wiki et le mit en ligne le 10 janvier6. À partir de ce moment, Larry Sanger travailla conjointement à l''encyclopédie Nupédia et à l''encyclopédie Wikipédia. Il participa particulièrement à la formulation de la majorité des politiques originelles.'),
(6, 7, NULL, NULL, 'Trop bon ! :)'),
(6, 7, NULL, NULL, 'Trop bon ! :)'),
(6, 7, NULL, NULL, 'Trop bon ! :)'),
(6, 7, NULL, NULL, 'Trop bon ! :)'),
(6, 7, NULL, NULL, 'Trop bon ! :)'),
