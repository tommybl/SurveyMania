...
-- -----------------------------------------------------
-- Table surveymania.widgets
-- -----------------------------------------------------
DROP TABLE IF EXISTS surveymania.widgets CASCADE;

CREATE TABLE  surveymania.widgets (
  id SERIAL NOT NULL,
  question_id INT NOT NULL,
...
-- -----------------------------------------------------
-- Table surveymania.widget_parameters
-- -----------------------------------------------------
DROP TABLE IF EXISTS surveymania.widget_parameters CASCADE;

CREATE TABLE  surveymania.widget_parameters (
  id SERIAL NOT NULL,
  ...
  CONSTRAINT fk_widget_id
    ...
    REFERENCES surveymania.widgets (id)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT fk_question_id
    FOREIGN KEY (question_id)
...
-- -----------------------------------------------------
-- Table surveymania.widget_parameter_values
-- -----------------------------------------------------
DROP TABLE IF EXISTS surveymania.widget_parameter_values CASCADE;

CREATE TABLE  surveymania.widget_parameter_values (
  id SERIAL NOT NULL,
  widget_parameter_id INT NOT NULL,
  option_choice_id INT NOT NULL,
  PRIMARY KEY (id),
  CONSTRAINT fk_widget_parameter_id
    FOREIGN KEY (widget_parameter_id)
    REFERENCES surveymania.widget_parameters (id)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT fk_option_choice_id
    FOREIGN KEY (option_choice_id)
