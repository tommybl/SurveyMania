...
surveyManiaControllers.controller('GameMailController', ['$scope', '$http', '$window', '$location', function($scope, $http, $window, $location) {
    ...
    $scope.emailContacts = "";
    $scope.GameMailSubmit = function (gameName, gameImage) {
        $scope.emailContent = " <!DOCTYPE html><html lang=\"fr\"><head><meta charset=\"utf-8\"><meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\"> <meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"><title>SurveyMania</title><link rel=\"stylesheet\" href=\"https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css\"><style>.games-images {width: 100%;border-radius: 5px;box-shadow: 2px 2px 10px #000;} body * {text-decoration: none!important;} a {text-decoration: none!important;} a * {text-decoration: none!important;} .games-description {margin: auto;width: 100%;background: rgba(0, 0, 0, 0.8);position: absolute;top: 56px; margin-right: 15px;font-family: 'Arial';color: #fff;padding: 50px;border-radius: 5px 5px 0 0;display: none;box-shadow: 2px 2px 10px #000;margin-top: 70px;margin-bottom: 100px;} .game-description { margin: auto;  width: 100%;background: rgba(0, 0, 0, 0.8);font-family: 'Arial';color: #fff;padding: 50px;padding-bottom: 200px;}</style> </head><body style=\"font-family: 'Arial'\"><div style=\"width: 100%; height: 100px; background: #f5c950; text-align: center\"> <h1 style=\"color: #fff; line-height: 100px\">SurveyMania &nbsp; <span style=\"color: #ddd; font-weight: normal\">|</span> &nbsp; <span style=\"font-weight: normal\">Relève le défi et viens me battre !</span></h1></div><a href=\"http://localhost:1337/#/game/" + $scope.game.id_game + "\"><div class=\"game-description\" > ";
                if ($scope.game_user[0].user_points < $scope.game.points_req) {
                    $scope.emailContent += "<h3 style=\"color: #fff\">" + $scope.game.name + "</h3><br><span style=\"color: #f5c950;\">Points requis: </span> " + $scope.game.points_req + " <br><span style=\"color: #f5c950;\">Points restants: </span> " + ($scope.game.points_req - $scope.game_user[0].user_points) + " <br><br> <div style=\"width: 60%\"><hr></div><br><p>" + $scope.game.description + "</p><br><div style=\"font-size: 50px; margin-top: -35px; display: inline-block;\"><i class=\"fa fa-users\" style=\"color: #999;\"></i> <span id=\"game_user_rank\">--</span>e&nbsp;&nbsp;&nbsp; | &nbsp;&nbsp;&nbsp;</div><div style=\"display: inline-block; font-size: 50px; margin-top: -35px;\"><i class=\"fa fa-trophy\" style=\"color: #d14836;\"></i> -- pts</div>";
                }
                else if ($scope.game.user_id != undefined) {
                    $scope.emailContent += "<h3 style=\"color: #fff\">" + $scope.game.name + "</h3><br><span style=\"color: #f5c950;\">Points requis: </span> " + $scope.game.points_req + " <br><span style=\"color: #f5c950;\">Points gagnés: </span> " + $scope.game.points + " <br><span style=\"color: #f5c950;\">Meilleur score: </span> " + $scope.game.score + " " + $scope.game.type + " <br><br> <div style=\"width: 60%\"><hr></div><br><p>" + $scope.game.description + "</p><br><div style=\"display: inline-block; font-size: 50px;\"><i class=\"fa fa-users\" style=\"color: #999;\"></i> <span id=\"game_user_rank\">" + $('#game_user_rank').html() + "</span>e&nbsp;&nbsp;&nbsp; | &nbsp;&nbsp;&nbsp;</div><div style=\"display: inline-block; font-size: 50px;\"><i class=\"fa fa-trophy\" style=\"color: #f5c950;\"></i> " + $scope.game.score + " pts</div>";
                }
                else if ($scope.game_user[0].user_points >= $scope.game.points_req && $scope.game.user_id == undefined) {
                    $scope.emailContent += "<h3 style=\"color: #fff\">" + $scope.game.name + "</h3><br><span style=\"color: #f5c950;\">Points requis: </span> " + $scope.game.points_req + " <br><span style=\"color: #f5c950;\">Points gagnés: </span> -- <br><span style=\"color: #f5c950;\">Meilleur score: </span> -- <br> <br><div style=\"width: 60%\"><hr></div><br><p>" + $scope.game.description + "</p><br><div style=\"display: inline-block; font-size: 50px;\"><i class=\"fa fa-users\" style=\"color: #999;\"></i> <span id=\"game_user_rank\">" + $('#game_user_rank').html() + "</span>e&nbsp;&nbsp;&nbsp; | &nbsp;&nbsp;&nbsp;</div><div style=\"display: inline-block; font-size: 50px;\"><i class=\"fa fa-trophy\" style=\"color: #d14836;\"></i> -- pts</div>";
                }
                $scope.emailContent += "</div></a></body></html>";
        if ($scope.emailContacts != "" && $scope.emailContacts != undefined) {
            $http.post('/app/games/share/mail', {mailContacts: $scope.emailContacts, mailContent: $scope.emailContent, mailGame: gameName, mailImage: gameImage})
            .success(function (data, status, header, config) {
