...
function preload() {
    ...
    game.load.tilemap('matching', 'js/phaser/assets/tilemaps/maps/phaser_tiles.json', null, Phaser.Tilemap.TILED_JSON);
    game.load.image('tiles', 'js/phaser/assets/tilemaps/tiles/phaser_tiles.png');//, 100, 100, -1, 1, 1);    
}
